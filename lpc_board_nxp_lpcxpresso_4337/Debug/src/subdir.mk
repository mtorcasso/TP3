...
src/%.o: ../src/%.c
	...
	arm-none-eabi-gcc -D__REDLIB__ -DDEBUG -D__CODE_RED -D__USE_LPCOPEN -DCORE_M4 -I"D:\Facultad\10 cuatri\Embebidos\git\workspace\LPCXpresso-FreeRTOS-Examples.zip_expanded\lpc_chip_43xx\inc" -I"D:\Facultad\10 cuatri\Embebidos\git\workspace\LPCXpresso-FreeRTOS-Examples.zip_expanded\lpc_board_nxp_lpcxpresso_4337\inc" -O0 -g3 -Wall -c -fmessage-length=0 -fno-builtin -ffunction-sections -fdata-sections -fsingle-precision-constant -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=softfp -mthumb -fstack-usage -specs=redlib.specs -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.o)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
